...
uses
  sysutils,
  rasterizer2d, utils, opf_common, pdo_v2;
...
type
  ...
  TFace2dRasterizer = class
    ...
    public
      ...
      procedure EndPart;
      class function BuildTextureTable(const pdo: TPdoV2Document): TTextureTableCtx;
...
class function TFace2dRasterizer.BuildTextureTable(const pdo: TPdoV2Document): TTextureTableCtx;
var
  i: integer;
...
begin
  ...
  for i := 0 to num_materials - 1 do begin
      ...
      begin
          ...
          result.textures[i].pixels := tex.data;
          result.textures[i].tex := TTexture2D.Create(tex.data, tex.width, tex.height);
      end
      else begin
      ...
      pixcolor.r := round(mat.color2d_argb[1] * 255);
      pixcolor.g := round(mat.color2d_argb[2] * 255);
      pixcolor.b := round(mat.color2d_argb[3] * 255);
