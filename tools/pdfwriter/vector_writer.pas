...
type
  ...
  TVecLineStyle = (lsLine, lsOutline, lsTab, lsValleyFold, lsMountainFold, lsFace);
  ...
  TVectorWriter = class
  public
    procedure InitDocProperties(const jp_font: boolean = false); virtual; abstract;
    procedure AddPage(const width, height: single); virtual; abstract;
